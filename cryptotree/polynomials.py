# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/polynomials.ipynb (unless otherwise specified).
...
def multiply_and_add_coeffs(powers: List[Ciphertext], plain_coeffs: List[Plaintext],
                            ...
                            evaluator: Evaluator,
                            scale: float,
                            tol=1e-6, verbose=False) -> Union[Ciphertext]:
...
def polyeval_tree(ctx : Ciphertext, coeffs: List[float],
                  evaluator: Evaluator, encoder : Encryptor,
    ...
    output = multiply_and_add_coeffs(powers, plain_coeffs, coeffs, evaluator, scale, verbose=verbose)
