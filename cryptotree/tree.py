# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/00_tree.ipynb (unless otherwise specified).

__all__ = ['shift_bit_eps', 'create_base_vectors', 'create_linear_system', 'BitComparison', 'chebyshev_approximation',
           'polynomial_approximation_coefficients', 'plot_graph_function_approximation', 'compute_leaves',
